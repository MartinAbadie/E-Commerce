...
var RechercheParTypeComponent = (function () {
    ...
    RechercheParTypeComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.recherche.getJSON("types/" + params['type']).subscribe(function (res) { return _this.items = res; }, function (err) { return console.error(err); }, function () { return console.log('done'); });
        });
    };
    RechercheParTypeComponent.prototype.ngAfterViewChecked = function () {
        var height = 20;
